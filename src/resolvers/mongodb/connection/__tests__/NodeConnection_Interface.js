...
const schema = `
  ...
  type Widget implements Node, Stuff {
    id: ID!
    name: String
    cost: Float
    users: NodeConnection(User, stuff, Props)
  ...
  type Gadget implements Node, Stuff {
    id: ID!
    name: String
    cost: Float
    users: NodeConnection(User, stuff, Props)
  ...
  type Gizmo implements Node, Stuff {
    id: ID!
    name: String
    cost: Float
    users: NodeConnection(User, stuff, Props)
...
function () {
  ...
  it('filterBy filters interface NodeConnection', async () => {
    const message = ` query Q {
      user(id: "-KCb1OwX6lMf7PUpOgjK-kJ5I") {
  ...
  it('count filters interface NodeConnection', async () => {
    const message = ` query Q {
      user(id: "-KCb1OwX6lMf7PUpOgjK-kJ5I") {
        test1: stuff {
  ...
  it('orderBy works with interface NodeConnection', async () => {
    const message = ` query Q {
      user(id: "-KCb1OwX6lMf7PUpOgjK-kJ5I") {
